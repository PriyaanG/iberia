                                                                                ...
                                                                                <div className="dropdown">
                                                                                  <button className="dropbtn">{flightNo}</button>
                                                                                    <div className="dropdown-content">
                                                                                      {flightNos.map((airtableFlightNo, index) => <button key={index} onClick={() => flightNoSet(airtableFlightNo)} height="30px" href="#" className="flight">{airtableFlightNo}<img className="bookinglogo"src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Flogos-world.net%2Fwp-content%2Fuploads%2F2020%2F12%2FIberia-Emblem.png&f=1&nofb=1&ipt=64a637335920b830fb2d63ef9656d6c6cf6430c145ff721493bc2fed7d198de5"></img></button>)}
                                                                                                     </div>
                                                                                                     </div>
                                                                                                             </div>
                                                                                                                 </>
