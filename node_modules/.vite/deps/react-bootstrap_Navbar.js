...
function useEventCallback2(fn) {
  ...
  return (0, import_react20.useCallback)(function(...args) {
    return ref.current && ref.current(...args);
  }, [ref]);
}
...
function useMergedRefs2(refA, refB) {
  return (0, import_react23.useMemo)(() => mergeRefs2(refA, refB), [refA, refB]);
}
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react24.useLayoutEffect : import_react24.useEffect;
...
var AbstractModalHeader = React20.forwardRef(({
  ...
  const context2 = (0, import_react30.useContext)(ModalContext_default);
...
var divWithClassName_default = ((className) => (
  ...
  React22.forwardRef((p, ref) => (0, import_jsx_runtime16.jsx)("div", {
    ...p,
    ref,
...
var Offcanvas = React24.forwardRef(({
  ...
  const modalManager = (0, import_react31.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react31.useState)(false);
  ...
  const renderBackdrop = (0, import_react31.useCallback)((backdropProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React25.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context2 = (0, import_react32.useContext)(NavbarContext_default);
...
var Navbar = React27.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react33.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react33.useMemo)(() => ({
